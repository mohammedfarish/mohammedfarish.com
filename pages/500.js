...
const Error500 = () => {
    return (
        <div className={styles.errorpage}>
            <CustomHead title="Internal Server Error | Mohammed Farish" />
            ...
            <div className={styles.errormessage}>
                <span>Not sure what went wrong but this should and has been addressed and the developer has been notified, as you read this.</span>
            </div>
