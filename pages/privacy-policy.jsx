    ...
    <div className={styles.privacyPage}>
      <div className={styles.privacySection}>
        ...
        <p>
          ...
          the collection, use and disclosure of Yourinformation when You use the Service
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              or &quot;Our&quot; in this Agreement) refers to Mohammed Farish.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              {" "}
              refers to Mohammed Farish, accessible from
              {" "}
              <a href="https://www.mohammedfarish.com" rel="external nofollow noopener noreferrer" target="_blank">https://www.mohammedfarish.com</a>
            </p>
          </li>
          <li>
            <p>
              ...
              entity on behalf of which such individual is accessing or using the Service or the
        ...
        <ul>
          ...
          <li>
            ...
            read &quot;Where can I change the settings for disabling, or deleting local shared
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              items or services You have purchased or of any other contract with Us through
              the Service.
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: privacy@mohammedfarish.com</li>
        </ul>
      </div>
