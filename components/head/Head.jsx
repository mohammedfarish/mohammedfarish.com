...
export default class CustomHead extends PureComponent {
  render() {
    return (
      <Head>
        <title>{this.props.title ? `${this.props.title} | Mohammed Farish` : "Mohammed Farish"}</title>
        ...
        <meta property="og:title" content={this.props.title ? `${this.props.title} | Mohammed Farish` : "Mohammed Farish"} />
        ...
        <meta property="twitter:title" content={this.props.title ? `${this.props.title} | Mohammed Farish` : "Mohammed Farish"} />
